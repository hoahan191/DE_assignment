...
class StageToRedshiftOperator(BaseOperator):
    ...
    def execute(self, context):
        self.log.info("Getting aws hook")
        ...
        self.log.info(f"Finish clearing data from table {self.table}")
        ...
        self.log.info(f"Finish copying data from S3 to table {self.table}")